...
from Busquedas import normalizar_texto  # Importar normalización para acentos

def filtrar_por_continente(paises: List[Dict[str, Any]], continente: str) -> List[Dict[str, Any]]:
    """
    Filtra países por continente (insensible a mayúsculas y acentos).
    ...
    resultados = [
        ...
        if continente_norm in normalizar_texto(pais['continente'])
    ]
